    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-5)' }}>
          ...
          <div>
            ...
            <div style={{ textAlign: 'right', marginTop: 'var(--space-2)' }}>
              <Link href="/forgot-password" style={{ fontSize: 'var(--text-sm)', color: '#14B8A6', transition: 'color 0.3s ease' }}>
                Forgot password?
              </Link>
            </div>
          </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 'var(--space-6)', fontSize: 'var(--text-sm)', color: 'var(--color-muted)' }}>
          ...
          <Link href="/register" style={{ color: '#14B8A6', fontWeight: 600, transition: 'color 0.3s ease' }}>
            Create one
          </Link>
        </p>
      </div>
