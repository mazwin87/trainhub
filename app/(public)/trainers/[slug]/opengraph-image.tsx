    ...
    (
      <div
        style={{
          ...
          background: 'linear-gradient(135deg, #A4472A 0%, #C65D3B 55%, #D9805E 100%)',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px' }}>
            <div style={{ width: '36px', height: '36px', background: 'white', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <div style={{ width: '20px', height: '20px', background: 'linear-gradient(135deg, #C65D3B, #D9805E)', borderRadius: '5px', display: 'flex' }} />
            </div>
