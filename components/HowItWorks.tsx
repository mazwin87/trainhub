      ...
      >
        <defs>
          <linearGradient id="hiw-timeline-grad" x1="0" y1="0" x2="1" y2="0">
            ...
            <stop offset="50%"  stopColor="#0F766E" stopOpacity="0.55" />
        ...
        <path
          ...
          fill="none"
        />
        <circle className="hiw-timeline-dot hiw-timeline-dot-1" cx="333" cy="6" r="3" fill="#0F766E" />
        <circle className="hiw-timeline-dot hiw-timeline-dot-2" cx="666" cy="6" r="3" fill="#0F766E" />
      </svg>
    </div>
  )
}
